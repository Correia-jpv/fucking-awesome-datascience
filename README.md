...
| [xonsh shell](https://github.com/xonsh/xonsh) | A Python-powered shell that enables the integration, management, and orchestration of data science libraries—primarily written in Python—into pipelines, code, and command-based workflows. It can also be used as a kernel for Jupyter Notebook.  |
